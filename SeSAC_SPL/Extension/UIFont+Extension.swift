...
extension UIFont {
    static let Display1_R20 = UIFont(name: "NotoSansKR-Regular", size: 50)
    ...
    static let Body3_R14 = UIFont(name: "NotoSansKR-Regular", size: 14)
    static let Body4_R12 = UIFont(name: "NotoSansKR-Regular", size: 12)
